...
setup(
    ...
    author_email='zhengwz18@mails.tsinghua.edu.cn',
    description='Code for OpenOcc',
    ...
    ext_modules=[
        make_cuda_ext(
            ...
            module='model.lifter.ops.voxel_pooling_train',
        ...
        make_cuda_ext(
            ...
            module='model.lifter.ops.voxel_pooling_inference',
